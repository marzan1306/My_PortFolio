...
$data = $conn->query("SELECT * FROM home_page WHERE id = 1")->fetch_assoc();

// Fetch all education entries
$result = $conn->query("SELECT * FROM about ORDER BY year DESC");

$rows = [];
if ($result && $result->num_rows > 0) {
    $rows = $result->fetch_all(MYSQLI_ASSOC); // fetch as associative array
}
// print_r($rows);
// die();
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6">
                        <div class="banner-content">
                            <h6><?= htmlspecialchars($data['hero_small_title']) ?></h6>
                            <h2><?= htmlspecialchars($data['hero_title']) ?></h2>
                            ...
                            <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                <ul>
                                    ...
                                    <li><a href="<?= $data['x_account']; ?>" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                        <div class="banner-img text-right">
                            <img src="../<?= !empty($data['hero_image']) ? $data['hero_image'] : 'img/banner/banner_img.png'; ?>" 
             class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
        ...
        <section id="about" class="about-area primary-bg pt-120 pb-120">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="../<?= !empty($data['hero_image2']) ? $data['hero_image2'] : 'img/banner/banner_img.png'; ?>" 
             class="img-fluid" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 pr-90">
                        ...
                        <?php foreach ($rows as $row):
                            ...
                            ?>
                        <div class="education">
                            <div class="year"><?= htmlspecialchars($row['year']); ?></div>
                            <div class="line"></div>
                            <div class="location">
